          ...
          <tbody>
            {data ? (data.map((item: Consulta) => (
                <tr key={item.id}>
                  ...
                  <td className="p-4 border-b border-blue-gray-50">
                    <span className="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md bg-green-500/20 text-green-600">
                      {item.status}
                    </span>
                  </td>
                  <td className="p-4 border-b border-blue-gray-50">
              ...
              <tr>
                <td colSpan={5} className="p-4 text-center">Carregando consultas...</td>
              </tr>
            )}
          </tbody>
        </table>
